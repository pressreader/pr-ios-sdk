...
@property (nullable, nonatomic, readonly) KalView *calendarView;
@property (nonatomic, strong) NSDate *minDate;    // The first day of the minimum allowed month
@property (nonatomic, strong) NSDate *maxDate;    // The first day of the maximaum allowed month
@property (nonatomic, assign) BOOL allowTheSameDateSelection;

- (instancetype)initWithSelectedDate:(NSDate *)selectedDate;  // designated initializer. When the calendar is first displayed to the user, the month that contains 'selectedDate' will be shown and the corresponding tile for 'selectedDate' will be automatically selected.
