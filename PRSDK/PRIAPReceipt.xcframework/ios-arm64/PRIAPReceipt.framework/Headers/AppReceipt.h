...
@property (nullable, nonatomic, strong) NSDictionary<NSString *, id> *decodedAppReceipt;
...
/** Array of in-app purchases contained in the receipt.
 @see AppReceiptIAP
 */
@property (nullable, nonatomic, strong, readonly) NSArray<AppReceiptIAP *> *inAppPurchases;

/** Array of in-app purchases contained in the decoded app receipt's "latest_receipt_info"
 @see AppReceiptIAP
 */
@property (nullable, nonatomic, strong, readonly) NSArray<AppReceiptIAP *> *latestInAppPurchases;

/** Latest receipt contained in decoded receipt
 */
@property (nullable, nonatomic, readonly) NSData *latestReceipt;
 ...
 */
- (BOOL) containsInAppPurchaseWithProductIdentifier:(NSString*)productIdentifier;

- (nullable AppReceiptIAP *) lastIAPForAutoRenewableSubscriptionWithProductIdentifier:(NSString *)productIdentifier;
 ...
 */
- (BOOL) containsActiveAutoRenewableSubscriptionWithProductIdentifier:(NSString *)productIdentifier forDate:(NSDate *)date;
- (BOOL) containsActiveTrialForAutoRenewableSubscriptionWithProductIdentifier:(NSString *)productIdentifier forDate:(NSDate *)date;

- (BOOL) containsTrialForAutorenewableSubscriptionWithIdentifier:(NSString *)productIdentifier;
- (BOOL) containsIntroductoryForAutorenewableSubscriptionWithIdentifier:(NSString *)productIdentifier;
- (BOOL) containsTrialOrIntroductoryForAutorenewableSubscriptionWithIdentifier:(NSString *)productIdentifier;

- (nullable NSArray<AppReceiptIAP *> *)subscriptionIAPs;
- (nullable NSArray<AppReceiptIAP *> *)trialOrIntroductoryIAPs;

- (nullable NSSet<NSString *> *) usedSubscriptionProducts;
- (nullable NSSet<NSString *> *) subscriptionProductsWithTrialOrIntroductoryIAPs;
- (nullable NSSet<NSString *> *) subscriptionProductsWithoutTrialOrIntroIAPsWithIdentifiers:(NSSet<NSString *> *)productIdentifiers;

/** Return InApp Purchase for specific transaction */
- (nullable AppReceiptIAP *)inAppPurchaseWithTransactionIdentifier:(NSString*)transactionIdentifier;
 ...
 */
+ (nullable AppReceipt*)bundleReceiptUsingLocalDecoding:(BOOL)useLocalDecoding;
 ...
 */
@interface AppReceiptIAP : NSObject
 ...
 */
@property (nullable, nonatomic, strong, readonly) NSDate *subscriptionExpirationDate;
 ...
 */
@property (nullable, nonatomic, strong, readonly) NSDate *cancellationDate;

/** For a transaction that was canceled by Apple customer support, the reason of the cancellation.
 * -1 if not decoded
 */
@property (nonatomic, readonly) NSInteger cancellationReason;

/** The primary key for identifying subscription purchases.
 */
@property (nonatomic, readonly) NSInteger webOrderLineItemID;

/** Other undocumented attributes ref'd by ASN.1 key
 */
@property (nullable, nonatomic, strong, readonly) NSDictionary<NSNumber *, id> *undocumentedAttrs;
...
/** Returns an initialized in-app purchase from the given decoded IAP.
 @param json decoded InAppPurchase
 @return An initialized in-app purchase from the given JSON dictionary.
 */
