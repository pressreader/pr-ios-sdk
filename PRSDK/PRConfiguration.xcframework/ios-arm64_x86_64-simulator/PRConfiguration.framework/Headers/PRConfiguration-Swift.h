...
@property (nonatomic, readonly, strong) PRConfigKey * _Nonnull previewBylineDarkColor;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly, strong) Font * _Nullable preview;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) BookReaderConfig * _Nonnull bookReaderConfig;)
