...
@property (nonatomic, readonly) NSInteger maxFontSizeAdjustment;
...
SWIFT_CLASS("_TtC15PRConfiguration21CatalogSchemeProvider")
...
SWIFT_CLASS("_TtC15PRConfiguration20CatalogSectionScheme")
...
@property (nonatomic, readonly) enum PRLayoutType layoutType;
@property (nonatomic, readonly, strong) CatalogSectionSchemeOption * _Nonnull options;
@property (nonatomic, readonly, strong) CatalogSectionSchemeOption * _Nonnull disclosedSectionOptions;
...
- (nonnull instancetype)initWithType:(enum PRCatalogSectionType)type sortingOrder:(PRCatalogSortingOrder)sortingOrder sortingOrderForSubsection:(PRCatalogSortingOrder)sortingOrderForSubsection layoutType:(enum PRLayoutType)layoutType options:(CatalogSectionSchemeOption * _Nonnull)options disclosedSectionOptions:(CatalogSectionSchemeOption * _Nonnull)disclosedSectionOptions customTitle:(NSString * _Nullable)customTitle cids:(NSArray<NSString *> * _Nullable)cids categories:(NSArray<NSString *> * _Nullable)categories OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC15PRConfiguration26CatalogSectionSchemeOption")
...
@property (nonatomic, readonly, strong) NewsFeedConfig * _Nonnull video;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly) BOOL observerStartOnLaunch;
@property (nonatomic, readonly) BOOL isRequired;
@property (nonatomic, readonly) BOOL useNativeUI;
@property (nonatomic, readonly) NSInteger uiScope;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC15PRConfiguration20IssueSearchConfigKey")
@interface IssueSearchConfigKey : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly) BOOL isNotificationBadgeEnabled;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly, strong) PRConfigKey * _Nonnull notificationBadgeEnabled;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_ENUM_FWD_DECL(NSInteger, PRNewsFeedAPI)
...
typedef SWIFT_ENUM(NSInteger, PRCatalogSectionType, open) {
  ...
  PRCatalogSectionTypeVideo = 15,
  PRCatalogSectionTypeOnlineEditions = 16,
  PRCatalogSectionTypeBannerBegin = 17,
  PRCatalogSectionTypeBannerHotspotServices = 18,
  PRCatalogSectionTypeBannerPremiumSubscription = 19,
  PRCatalogSectionTypeBannerImproveExperience = 20,
  PRCatalogSectionTypeBannerPersonalizationCompleted = 21,
  PRCatalogSectionTypeBannerBooks = 22,
  PRCatalogSectionTypeBannerBrazeContentCard = 23,
  PRCatalogSectionTypeBannerAll = 24,
  PRCatalogSectionTypeBannerEnd = 25,
  PRCatalogSectionTypeCategories = 26,
  PRCatalogSectionTypeFullCatalog = 27,
  PRCatalogSectionTypeCategoryContent = 28,
/// Special categories for custom catalog. Might support rows in the future.
  PRCatalogSectionTypeSections = 29,
  PRCatalogSectionTypeHotSpot = 30,
  PRCatalogSectionTypeLatestPublishDay = 31,
  PRCatalogSectionTypeTopAdBanner = 32,
  PRCatalogSectionTypeInlineAdBanner = 33,
  PRCatalogSectionTypePartnerBanner = 34,
  PRCatalogSectionTypeEnd = 35,
};
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AppInfoConfig * _Nonnull appInfoConfig;)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL tooltipsEnabled;)
+ (BOOL)tooltipsEnabled SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSDate * _Nonnull launchDate;)
+ (NSDate * _Nonnull)launchDate SWIFT_WARN_UNUSED_RESULT;
+ (void)setLaunchDate:(NSDate * _Nonnull)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) double screenScale;)
+ (double)screenScale SWIFT_WARN_UNUSED_RESULT;
+ (void)setScreenScale:(double)newValue;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) PRConfigKey * _Nonnull launchDate;)
+ (PRConfigKey * _Nonnull)launchDate SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) PRConfigKey * _Nonnull screenScale;)
+ (PRConfigKey * _Nonnull)screenScale SWIFT_WARN_UNUSED_RESULT;
@end

typedef SWIFT_ENUM(NSInteger, PRLayoutType, open) {
  PRLayoutTypeNone = 0,
  PRLayoutTypeCarousel = 1,
  PRLayoutTypeGrid = 2,
};
...
@property (nonatomic, readonly) BOOL infoBarHidden;
@property (nonatomic, readonly) BOOL mastheadHidden;
@end
...
@property (nonatomic, readonly, strong) IssueSearchConfigKey * _Nonnull issue;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
