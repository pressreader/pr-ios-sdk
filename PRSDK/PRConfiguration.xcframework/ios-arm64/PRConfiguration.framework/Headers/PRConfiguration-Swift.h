...
- (nonnull instancetype)initWithType:(enum PRCatalogSectionType)type sortingOrder:(PRCatalogSortingOrder)sortingOrder sortingOrderForSubsection:(PRCatalogSortingOrder)sortingOrderForSubsection layoutType:(enum PRLayoutType)layoutType options:(CatalogSectionSchemeOption * _Nonnull)options customTitle:(NSString * _Nullable)customTitle cids:(NSArray<NSString *> * _Nullable)cids categories:(NSArray<NSString *> * _Nullable)categories OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly, strong) PRConfigKey * _Nonnull infoBarHidden;
@property (nonatomic, readonly, strong) PRConfigKey * _Nonnull mastheadHidden;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
