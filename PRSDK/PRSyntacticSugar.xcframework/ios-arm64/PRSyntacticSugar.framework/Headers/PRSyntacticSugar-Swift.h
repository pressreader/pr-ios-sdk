...
#ifndef PRSYNTACTICSUGAR_SWIFT_H
#define PRSYNTACTICSUGAR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PRSyntacticSugar",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@interface NSDictionary<KeyType, ObjectType> (SWIFT_EXTENSION(PRSyntacticSugar))
- (NSString * _Nullable)stringForKey:(NSString * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)nonEmptyStringForKey:(NSString * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)stringForKeys:(NSArray<NSString *> * _Nonnull)keys SWIFT_WARN_UNUSED_RESULT;
...
@interface PRBlockUtil (SWIFT_EXTENSION(PRSyntacticSugar))
+ (void)performWithCheckInterval:(NSTimeInterval)checkInterval timeout:(NSTimeInterval)timeout condition:(BOOL (^ _Nonnull)(void))condition block:(void (^ _Nonnull)(void))block;
@end
...
- (BOOL)contains:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
