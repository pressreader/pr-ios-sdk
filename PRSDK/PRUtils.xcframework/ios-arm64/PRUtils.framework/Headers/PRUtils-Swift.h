...
- (NSString * _Nullable)firstURLScheme SWIFT_WARN_UNUSED_RESULT;
...
@protocol PRNetworkMonitorObserver;
SWIFT_CLASS_NAMED("NetworkMonitor")
@interface PRNetworkMonitor : NSObject
@property (nonatomic) enum PRNetworkStatus status;
@property (nonatomic, readonly) BOOL isConnected;
- (void)start;
- (void)cancel;
- (void)addObserver:(id <PRNetworkMonitorObserver> _Nonnull)observer;
- (void)removeObserver:(id <PRNetworkMonitorObserver> _Nonnull)observer;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM_NAMED(NSInteger, PRNetworkStatus, "Status", open) {
  PRNetworkStatusUnknown = -1,
  PRNetworkStatusNotReachable = 0,
  PRNetworkStatusWiFi = 1,
  PRNetworkStatusCellular = 2,
};

SWIFT_PROTOCOL_NAMED("NetworkMonitorObserver")
@protocol PRNetworkMonitorObserver
