...
#ifndef PRANALYTICS_SWIFT_H
#define PRANALYTICS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PRAnalytics",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP11PRAnalytics17AnalyticsProvider_")
@protocol AnalyticsProvider
@end

@class NSDate;
@class NSString;
SWIFT_PROTOCOL("_TtP11PRAnalytics22IssueAnalyticsProvider_")
...
@interface NSURL (SWIFT_EXTENSION(PRAnalytics))
- (void)track;
@end

SWIFT_CLASS("_TtC11PRAnalytics18PRAnalyticsService")
@interface PRAnalyticsService : NSObject
@property (nonatomic, readonly, copy) NSArray<id <AnalyticsService>> * _Nonnull services;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface PRAnalyticsService (SWIFT_EXTENSION(PRAnalytics)) <PRPageViewTracker>
- (void)tracker:(NSString * _Nonnull)trackerId pageView:(NSString * _Nonnull)pageUrl;
@end

@interface PRAnalyticsService (SWIFT_EXTENSION(PRAnalytics)) <AnalyticsService>
...
@interface PRAnalyticsService (SWIFT_EXTENSION(PRAnalytics)) <PRGATracker>
...
SWIFT_PROTOCOL("_TtP11PRAnalytics26RichMediaAnalyticsProvider_")
...
SWIFT_PROTOCOL("_TtP11PRAnalytics31RichMediaPhotoAnalyticsProvider_")
...
typedef SWIFT_ENUM_NAMED(NSInteger, PRSponsorshipStatus, "SponsorshipStatus", open) {
  PRSponsorshipStatusNone = 0,
  PRSponsorshipStatusActive = 1,
  PRSponsorshipStatusNonActive = 2,
  PRSponsorshipStatusRestricted = 3,
  PRSponsorshipStatusDisabled = 4,
  PRSponsorshipStatusInvalid = 5,
  PRSponsorshipStatusCooldown = 6,
  PRSponsorshipStatusExpired = 999,
  PRSponsorshipStatusLoginRequired = 9999,
};
