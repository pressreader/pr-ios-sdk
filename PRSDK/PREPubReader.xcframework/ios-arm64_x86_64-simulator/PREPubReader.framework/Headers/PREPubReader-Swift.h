...
#ifndef PREPUBREADER_SWIFT_H
#define PREPUBREADER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PREPubReader",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSCoder;
SWIFT_CLASS("_TtC12PREPubReader21BookHighlightMenuCell")
@interface BookHighlightMenuCell : UITableViewCell
...
@class PRPromise;
SWIFT_CLASS("_TtC12PREPubReader10EPubReader")
@interface EPubReader : NSObject
+ (PRPromise * _Nonnull)getEPubReader:(EpubContent * _Nonnull)epub httpServer:(id <PRWebServerBookRegister> _Nonnull)httpServer subscription:(id <PRSubscriptionCatalogProtocol> _Nullable)subscription SWIFT_WARN_UNUSED_RESULT;
