...
- (void)requestProfileWithCompletionHandler:(nullable void(^)(id _Nullable responseObject, NSError *_Nullable error))completionBlock;
...
- (void)requestNotificationSettingsWithCompletionHandler:(nullable void(^)(id _Nullable responseObject, NSError * _Nullable error))completionBlock;
