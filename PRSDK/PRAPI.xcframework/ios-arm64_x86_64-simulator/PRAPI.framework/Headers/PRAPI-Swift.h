...
- (PRPromise * _Nonnull)updateDetailsIfNeeded SWIFT_WARN_UNUSED_RESULT;
- (void)updateDetailsIfNeededWithCompletionHandler:(void (^ _Nonnull)(NSError * _Nullable))completionHandler;
- (PRTitleItemExemplarState)downloadStateWithOptions:(CatalogItemContentOption * _Nonnull)options SWIFT_WARN_UNUSED_RESULT;
- (PRPromise * _Nonnull)downloadWithOptions:(CatalogItemContentOption * _Nonnull)options SWIFT_WARN_UNUSED_RESULT;
- (void)onDownloadError:(NSError * _Nullable)error;
- (void)completeLicensePurchaseWithIsFailed:(BOOL)isFailed;
@end
...
SWIFT_CLASS("_TtC5PRAPI18BookLibraryService")
@interface BookLibraryService : BookSubservice
@end
...
@interface CatalogItem (SWIFT_EXTENSION(PRAPI))
- (PRPromise * _Nonnull)downloadWithOptions:(CatalogItemContentOption * _Nonnull)options;
@end
...
- (void)removeFromDownloads:(PRSimpleResult _Nullable)completion;
@end

@class NSProgress;

SWIFT_PROTOCOL("_TtP5PRAPI16DownloadableItem_")
...
@interface CatalogItem (SWIFT_EXTENSION(PRAPI)) <DownloadableItem>
@property (nonatomic, readonly, copy) NSString * _Nonnull identifier;
- (PRTitleItemExemplarState)downloadStateWithOptions:(CatalogItemContentOption * _Nonnull)options SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)downloadProgressWithOptions:(CatalogItemContentOption * _Nonnull)options SWIFT_WARN_UNUSED_RESULT;
- (NSProgress * _Nullable)downloadProgressObjectWithOptions:(CatalogItemContentOption * _Nonnull)options SWIFT_WARN_UNUSED_RESULT;
...
- (void)waitForOtherDataSuppliers:(void (^ _Nonnull)(void))completion;
@end
...
- (BOOL)mastheadWithHeight:(CGFloat)height style:(NTFMastheadStyle)style options:(NTFMastheadOption)options completion:(void (^ _Nullable)(UIImage * _Nullable, NSError * _Nullable))completion;
@end
...
@interface PRCatalog (SWIFT_EXTENSION(PRAPI))
- (void)load:(void (^ _Nonnull)(void))completion;
...
- (Downloads * _Nonnull)downloads SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, readonly, strong) id <PRMastheadProvider> _Nullable mastheadProvider;
@end
