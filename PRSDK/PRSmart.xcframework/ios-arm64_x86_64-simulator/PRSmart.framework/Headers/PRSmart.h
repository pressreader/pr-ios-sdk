...
//! Project version string for PRSmart.
FOUNDATION_EXPORT const unsigned char PRSmartVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <PRSmart/PublicHeader.h>
